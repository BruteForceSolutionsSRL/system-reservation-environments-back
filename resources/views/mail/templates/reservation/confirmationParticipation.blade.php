...
<div class="container">
    ...
    <div class="content">
        <p>Usted fue asignado a la siguiente solicitud/reserva.</p>
        <p>{{$details['body']}}</p>
        ...
        <h3>¿Desea participar en la solicitud/reserva?</h3>
        <a href="{{ $details['url'] }}">Para confirmar su participacion haga clic en este enlace.</a>
    </div>
    <hr>
    <div class="footer">
