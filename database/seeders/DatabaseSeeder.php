...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        $people = [
            ...
            ['name' => 'AGUSTIN',       'last_name' => 'GUZMAN',              'email' => 'xdxdagustin.g@gmail.com'],                    /*ID 4*/
            ['name' => 'MARIBEL',       'last_name' => 'JAMIRA',              'email' => 'xdxdmaribel.j@gmail.com'],                    /*ID 5*/
            ['name' => 'ALEJANDRO',     'last_name' => 'GARCIA',              'email' => 'xdxdalejandro.g@gmail.com'],                  /*ID 6*/
            ['name' => 'ROBERTO',       'last_name' => 'VALENZUELA MIRANDA',  'email' => 'xdxdroberto.v@fcyt.umss.edu'],                /*ID 7*/    
            ['name' => 'RENE',          'last_name' => 'MOREIRA CALIZAYA',    'email' => 'xdxdrene.m@fcyt.umss.edu'],                   /*ID 8*/
